...
**`ecore.ENamedElement` doSomething(`EInt[]` i, `<<config-IENamedElementConfig, config.{zwsp}IENamedElementConfig>>` something) throws `<<config-Npe, config.{zwsp}Npe>>`, `<<config-Npe, config.{zwsp}Npe>>`**
