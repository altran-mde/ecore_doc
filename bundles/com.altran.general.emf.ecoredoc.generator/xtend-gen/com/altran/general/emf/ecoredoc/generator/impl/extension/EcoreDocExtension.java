...
public class EcoreDocExtension {
  public static final String ECLASSIFIER_PROPERTY_SEPARATOR = EcoreDocExtension.newline();
  
  public static final Function1<EClassifier, String> eClassifierSorter = ((Function1<EClassifier, String>) (EClassifier it) -> {
    String _elvis = null;
  ...
  public static final Function1<EStructuralFeature, String> eStructuralFeatureSorter = ((Function1<EStructuralFeature, String>) (EStructuralFeature it) -> {
    String _elvis = null;
  ...
  public static final Function1<EOperation, String> eOperationSorter = ((Function1<EOperation, String>) (EOperation it) -> {
    String _elvis = null;
    String _name = it.getName();
    if (_name != null) {
      _elvis = _name;
