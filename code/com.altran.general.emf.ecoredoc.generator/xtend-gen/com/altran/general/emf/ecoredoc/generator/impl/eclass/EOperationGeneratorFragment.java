...
public class EOperationGeneratorFragment extends AEClassMemberGeneratorFragment {
  public final static Comparator<EOperation> eOperationBodyComparator = ((Comparator<EOperation>) (EOperation a, EOperation b) -> {
  ...
  public final static Function2<EOperation, EOperation, Integer> eOperationComparator = ((Function2<EOperation, EOperation, Integer>) (EOperation a, EOperation b) -> {
    String _name = a.getName();
    String _name_1 = b.getName();
    boolean _equals = Objects.equal(_name, _name_1);
    if (_equals) {
