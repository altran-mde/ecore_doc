 ...
 * @generated
 */
public class EcoredocExtensionSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public EcoredocExtensionSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case EcoredocExtensionPackage.ECORE_DOC_GENERATION: {
			EcoreDocGeneration ecoreDocGeneration = (EcoreDocGeneration) theEObject;
			T result = caseEcoreDocGeneration(ecoreDocGeneration);
			if (result == null)
				result = caseEcoreElement(ecoreDocGeneration);
			if (result == null)
				result = caseGenerationElement(ecoreDocGeneration);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Ecore Doc Generation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Ecore Doc Generation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEcoreDocGeneration(EcoreDocGeneration object) {
		return null;
	}
